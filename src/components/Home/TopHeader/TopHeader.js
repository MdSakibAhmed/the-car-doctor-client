...
const TopHeader = () => {
  return (
    <div
      ...
      className="container-fluid p-2 text-white d-none d-md-block"
    >
      <div style={{ width: "800px" }} className="ml-5 text-center">
        <p className="d-inline mr-4 ">
          {" "}
          <FontAwesomeIcon icon={faMapMarkerAlt} /> Kuril Badda Dhaka 1229
        </p>
        <p className="d-inline mr-5">
          {" "}
          <FontAwesomeIcon icon={faClock} /> Sun - Fri, 9.00AM - 5.00PM
        </p>
        <p className="d-inline mr-4">
          {" "}
          <FontAwesomeIcon icon={faPhoneAlt} /> +880132675545
        </p>
