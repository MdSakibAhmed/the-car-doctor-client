    ...
    return (
        ...
        <div style={{background:"#F2F2F2"}} className="row pr-5 pl-4 pt-5">
            ...
            <div className="col-md-3">
                <h2 >Our Product</h2>
                <ul className='p-0' >
                    <li> <FontAwesomeIcon icon={faCheckCircle}/> Tire and Wheel Services</li>
                    <li> <FontAwesomeIcon icon={faCheckCircle}/> Brake Repair</li>
                    <li><FontAwesomeIcon icon={faCheckCircle}/> Engine Diagnostics</li>
                    <li><FontAwesomeIcon icon={faCheckCircle}/> Belts and Hoses</li>
                    <li><FontAwesomeIcon icon={faCheckCircle}/> Lube, Oil and Filters</li>
                    <li><FontAwesomeIcon icon={faCheckCircle}/> Other Car Services</li>
                </ul>
            </div>
            <div className="col-md-3">
                <h2>Newsletters</h2>
